...
ID3D10InputLayout* InputLayout::PosNormal           = 0;
void InputLayout::InitAll(ID3D10Device* device)
{
   ...
   /* D3D10_INPUT_ELEMENT_DESC  posNormalDesc[] = 
    {
        {"POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 0, D3D10_INPUT_PER_VERTEX_DATA, 0},
        {"NORMAL",   0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 12, D3D10_INPUT_PER_VERTEX_DATA, 0}
    };
    fx::GenGBufferFX->GetTechniqueByName("GenGBufferTech")->GetPassByIndex(0)->GetDesc(&PassDesc);
    HR(device->CreateInputLayout(posNormalDesc,2, PassDesc.pIAInputSignature, PassDesc.IAInputSignatureSize, &PosNormal));*/
}
